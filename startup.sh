...
install_argocd() {
    ...
    helm install argocd /Users/sabapatm/Docs/mk_workspace/argocd/helm-chart/argo-cd-8.2.2/argo-cd \
        --namespace argocd \
        --values /Users/sabapatm/Docs/mk_workspace/argocd/helm-chart/argo-cd-8.2.2/minimal-custom-values.yaml
